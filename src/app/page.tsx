      ...
      <section id="hero" className="relative bg-gradient-to-r from-dark to-primary text-white py-24 rounded-b-3xl overflow-hidden shadow-xl">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl text-center md:text-left">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight drop-shadow-lg">Secure & <span className="text-accent">Hassle-Free</span> Utility Bill Payments</h1>
            <p className="text-xl md:text-2xl mb-10 text-textLight leading-relaxed">Pay your utility bills instantly from anywhere. 100% secure transactions with real-time updates.</p>
            <div className="flex flex-col sm:flex-row gap-5 justify-center md:justify-start">
              <Link href="/pay-premium" className="bg-accent hover:bg-secondary text-dark font-bold py-4 px-10 rounded-full text-lg text-center transition duration-300 shadow-lg">Pay Bill Now</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-lightBg">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-dark mb-6">How to Pay Your Utility Bill</h2>
            <p className="text-gray-600 text-xl leading-relaxed">Simple, secure, and convenient bill payment in just a few streamlined steps.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            {["Register / Login", "Select Biller", "Choose Payment", "Get Confirmation"].map((title, idx) => (
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-cardBg p-10 rounded-2xl shadow-xl border border-lightBg">
            ...
            <div className="rounded-xl overflow-hidden shadow-lg h-full border border-lightBg">
              <img src="/utility.jpg" alt="Utility bills" className="h-full w-full object-cover" />
            </div>
          </div>
        </div>
      </section>
