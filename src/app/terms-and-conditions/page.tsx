    ...
    return (
        <main className="flex-grow max-w-4xl mx-auto px-4 py-16">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
                <p className="mb-6">
                    These terms govern your use of "KB Topay Finnovative LLP" services including online payments and related features. Please read them carefully.
                </p>
                <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">General</h2>
                <p className="mb-6">This website and app are operated by "KB Topay Finnovative LLP". By using the Services, you agree to these terms.</p>
                ...
                <p className="mb-6">Users are responsible for safeguarding credentials. "KB Topay Finnovative LLP" employs robust security practices.</p>
